...
<ParamField body="withdrawalPercentage" type="number" required>
  Percentage of unlocked liquidity to withdraw (0 < value <= 100). For example, `50` withdraws 50% of available liquidity.
</ParamField>
...
<AccordionGroup>
  ...
  <Accordion title="400 - Invalid Withdrawal Percentage">
    ...
    The withdrawal percentage must be greater than 0 and not exceed 100.
  </Accordion>
...
Ensures withdrawalPercentage is provided and is a valid number between 0 and 100
</Step>
